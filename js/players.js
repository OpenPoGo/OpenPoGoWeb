  ...
  createElements: function(){
   ...
   for (var i = 0; i < self.settings.users.length; i++) {
    ...
    $div.html(
      ...
      '</header>'+ 
      '<div class="eggs"></div>' +
      '<div class="sortby">SORT BY: <span class="name" >name</span> '+
...
/*    out = out.replace(/<\/div><div/g, function (match, i, original) {
  ...
  updateDivs: function(user_index) {
    ...
    self.userDivs[user_index].inventory.html(players.sortAndShowBagPokemon(self.sortBy, user_index));
